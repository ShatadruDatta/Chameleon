...
struct JobSheetModels: Codable {
    let insPartnerContactPerson, delClientContactPerson, insClientContactPerson: [ContactPerson]
        let installationAddress: Address
        let service: Service
        ...
        let state, engineerNotes2, clientOrderRef: String
        let id: Int
